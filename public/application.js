...
(function() {
  ...
  Image = (function() {
    ...
    Image.prototype.shuffle = function() {
      var callback, newImage, oldImage;
      if (this.throttle) {
        return;
      }
      this.throttle = true;
      this.el.addClass('fade');
      oldImage = _.last(this.el.attr('src').split('/')).replace('.svg', '');
      newImage = _.sample(this.images);
      ...
      callback = (function(_this) {
        return function() {
          _this.el.attr('src', "" + _this.imagePath + "/" + newImage + ".svg");
          _this.el.removeClass('fade');
    ...
    Image.prototype.showMessage = function() {
      var callback;
      clearTimeout();
      this.notice.text("Same image " + (this.counter + 1) + " times in a row, that must be really annoying for you.").append("<img src='" + this.imagePath + "/avatar_white.svg'>").css('opacity', 1);
      callback = function() {
...
(function() {
  ...
  Header = (function() {
    ...
    Header.prototype.hide = function() {
      return this.el.addClass('headroom--unpinned');
    };
  ...
  Blog = (function() {
    function Blog(options) {
      ...
      if (options.image != null) {
        this.image = new Image($('.main-image'));
      }
